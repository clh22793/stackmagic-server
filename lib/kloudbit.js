...
var kb = function(){
    ...
    this.post = function(data, callback){
        var config = {
            url: this.config.url+'v1/'+this.resource,
            method: 'post',
            data:data
        };

        if(this.resource == 'users'){
            config.headers = {Authorization:'Basic '+this.kloudbit_token};
        }else{
    ...
    this.put = function(id, data, callback){
        var config = {
            url: this.config.url+'v1/'+this.resource+'/'+id,
            method: 'put',
            data:data
        };
    ...
    this.get_access_token = function(username, password, callback){
        var config = {
...
kb.prototype.uri = function(uri){
    this.resource = uri;

    if(!this.verify_schema(this.resource)){
...
kb.prototype.fetch = function(callback){
...
kb.prototype.get = function(id, callback){
...
kb.prototype.update = function(id, data, callback){
    ...
    this.put(id, data, callback);
};

kb.prototype.remove = function(id, callback){
...
kb.prototype.authenticate = function(username, password, callback){
    this.get_access_token(username,password,callback);
};
