...
kb.prototype.add = function(data, callback){
    ...
    this.post_request(this.resource, data, callback);
...
kb.prototype.get = function(callback){
    ...
    this.get_request(this.resource, callback);
};
...
kb.prototype.update = function(data, callback){
    ...
    this.put_request(this.resource, data, callback);
};
...
kb.prototype.remove = function(callback){
    ...
    this.delete_request(this.resource, callback);
};
